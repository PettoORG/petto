...
const _$PetBreedEnumMap = {
  ...
  PetBreed.hollandLop: 'hollandLop',
  PetBreed.miniRex: 'miniRex',
  PetBreed.lionhead: 'lionhead',
  PetBreed.netherlandDwarf: 'netherlandDwarf',
  PetBreed.miniLop: 'miniLop',
  PetBreed.flemishGiant: 'flemishGiant',
  PetBreed.englishAngora: 'englishAngora',
  PetBreed.rex: 'rex',
  PetBreed.polish: 'polish',
  PetBreed.harlequin: 'harlequin',
  PetBreed.budgerigar: 'budgerigar',
  PetBreed.cockatiel: 'cockatiel',
  PetBreed.canary: 'canary',
  PetBreed.lovebird: 'lovebird',
  PetBreed.africanGrey: 'africanGrey',
  PetBreed.parakeet: 'parakeet',
  PetBreed.conure: 'conure',
  PetBreed.finch: 'finch',
  PetBreed.amazonParrot: 'amazonParrot',
  PetBreed.cockatoo: 'cockatoo',
  PetBreed.betta: 'betta',
  PetBreed.goldfish: 'goldfish',
  PetBreed.guppy: 'guppy',
  PetBreed.angelfish: 'angelfish',
  PetBreed.molly: 'molly',
  PetBreed.platy: 'platy',
  PetBreed.neonTetra: 'neonTetra',
  PetBreed.swordtail: 'swordtail',
  PetBreed.cichlid: 'cichlid',
  PetBreed.zebraDanio: 'zebraDanio',
